...
EXERCISES = {
    item["id"]: item
    for item in [
        _exercise("chair-squat", "Rejs-sæt-dig fra stol", "squat", "ben", ["lår", "baller"], "Stabil stol", "Sæt dig kontrolleret mod stolens forkant og rejs dig ved at presse fødderne i gulvet.", ["Knæ følger tæernes retning", "Hold brystet løftet", "Sæt dig langsomt"], "Brug armlæn eller en højere stol.", "Rør kun let stolen eller hold en let vægt ved brystet."),
        _exercise("bodyweight-squat", "Kontrolleret squat", "squat", "ben", ["lår", "baller", "mave"], "Ingen", "Skub hoften roligt bagud, bøj knæene og rejs dig igen med vægten fordelt over hele foden.", ["Roligt tempo", "Lang ryg", "Kun så dybt som behageligt"], "Sæt dig på en stol mellem hver gentagelse.", "Hold en let rygsæk ved brystet."),
        ...
        _exercise("incline-pushup", "Armbøjning mod bord", "wall", "pres", ["bryst", "skuldre", "arme", "mave"], "Solid bordkant", "Hold kroppen i en lige linje, sænk brystet mod bordkanten og pres roligt tilbage.", ["Bordet må ikke kunne flytte sig", "Kroppen bevæges samlet", "Rolig udånding på vej op"], "Brug en væg.", "Brug en lavere, helt stabil støtte."),
        _exercise("seated-band-row", "Siddende træk med elastik", "band", "træk", ["øvre ryg", "bagskulder", "arme"], "Træningselastik", "Sid højt, før elastikken sikkert omkring fødderne og træk albuerne roligt bagud.", ["Skuldre væk fra ørerne", "Saml skulderbladene let", "Slip langsomt frem"], "Brug en lettere elastik eller mindre bevægelse.", "Hold ét sekund i den bageste position."),
        _exercise("standing-band-row", "Stående træk med elastik", "band", "træk", ["øvre ryg", "bagskulder", "arme", "mave"], "Fastgjort træningselastik", "Stå stabilt og træk albuerne bagud uden at læne kroppen tilbage.", ["Fastgør elastikken forsvarligt", "Bløde knæ", "Lang nakke"], "Lav øvelsen siddende.", "Brug en lidt strammere elastik."),
        _exercise("wall-plank", "Planke mod væg", "plank", "kropsstamme", ["mave", "ryg", "skuldre"], "Væg", "Sæt underarmene mod væggen, træd lidt tilbage og hold kroppen lang med rolig vejrtrækning.", ["Undgå at holde vejret", "Spænd let – ikke maksimalt", "Hold hovedet i forlængelse af ryggen"], "Stå tættere på væggen.", "Brug en solid bordkant."),
        _exercise("knee-plank", "Planke på knæ", "plank", "kropsstamme", ["mave", "ryg", "skuldre"], "Måtte", "Støt på underarme og knæ og hold en lige linje fra hoved til knæ.", ["Rolig vejrtrækning", "Pres gulvet let væk", "Stop før ryggen hænger"], "Lav planke mod væg.", "Forlæng holdet lidt eller løft knæene kortvarigt."),
        _exercise("chair-march", "Siddende march", "chair", "puls", ["hofter", "lår", "mave"], "Stabil stol", "Sid højt og løft skiftevis den ene og den anden fod i et roligt tempo.", ["Hold overkroppen rolig", "Sæt foden blødt", "Træk vejret frit"], "Løft fødderne mindre.", "Marchér stående med støtte ved stolen."),
        _exercise("seated-leg-extension", "Siddende knæstræk", "chair", "ben", ["forside lår"], "Stabil stol", "Stræk ét knæ ad gangen, hold kort og sænk foden kontrolleret.", ["Ingen sving", "Sid helt tilbage", "Bevæg kun i smertefrit område"], "Gør bevægelsen kortere.", "Hold to sekunder med strakt ben.", "Spring øvelsen over ved tiltagende knæsmerter."),
        ...
        _exercise("bridge-hold", "Hofteløft med kort hold", "bridge", "hofte", ["baller", "baglår", "mave"], "Måtte", "Løft hoften som i et almindeligt hofteløft og hold positionen, mens du trækker vejret roligt.", ["Spænd i ballerne", "Ribbenene holdes rolige", "Sænk før teknikken svigter"], "Lav almindelige gentagelser uden hold.", "Forlæng holdet med fem sekunder."),
        _exercise("supported-step-up", "Lavt step-up med støtte", "step", "ben", ["lår", "baller", "læg", "balance"], "Lavt trin og gelænder", "Sæt hele foden på et lavt trin, pres dig roligt op og træd kontrolleret ned igen.", ["Hold ved gelænder", "Knæ følger tæerne", "Skift startben"], "Brug nederste trappetrin og meget let støtte.", "Brug mindre håndstøtte."),
        ...
        _exercise("supported-calf-raise", "Hælløft med støtte", "calf", "underben", ["læg", "fødder", "balance"], "Stol eller væg", "Hold let ved en støtte, løft hælene og sænk dem langsomt helt ned igen.", ["Vægten over storetå og lilletå", "Ingen hop", "Stå højt"], "Løft hælene mindre.", "Hold to sekunder på toppen."),
        _exercise("calf-raise", "Frit hælløft", "calf", "underben", ["læg", "fødder", "balance"], "Ingen", "Løft hælene roligt, find balancen og sænk kontrolleret.", ["Se på et fast punkt", "Roligt tempo", "Hav en støtte inden for rækkevidde"], "Hold ved en stol.", "Lav skiftevis lidt mere vægt på ét ben."),
        _exercise("seated-shoulder-press", "Siddende skulderpres", "shoulder", "pres", ["skuldre", "arme"], "To vandflasker eller lette håndvægte", "Sid højt og pres lette vægte op uden at løfte skuldrene mod ørerne.", ["Start meget let", "Håndled over albuer", "Sænk roligt"], "Pres én arm ad gangen uden vægt.", "Brug en anelse mere vægt, hvis teknikken er stabil."),
        _exercise("standing-shoulder-press", "Stående skulderpres", "shoulder", "pres", ["skuldre", "arme", "mave"], "To vandflasker eller håndvægte", "Stå stabilt, spænd let i maven og pres vægtene kontrolleret over hovedet.", ["Undgå at svaje", "Bløde knæ", "Stop hvis skulderen gør ondt"], "Lav øvelsen siddende og lettere.", "Pres skiftevis én arm ad gangen."),
        _exercise("seated-biceps-curl", "Siddende armbøjning med vægt", "biceps", "arme", ["arme"], "Vandflasker eller håndvægte", "Hold albuerne tæt ved siden og bøj armene uden at svinge kroppen.", ["Rolig vej ned", "Afslappede skuldre", "Neutral håndledsstilling"], "Brug mindre eller ingen vægt.", "Hold ét sekund på toppen."),
        _exercise("standing-biceps-curl", "Stående armbøjning med vægt", "biceps", "arme", ["arme", "mave"], "Vandflasker eller håndvægte", "Stå højt og bøj armene, mens albuerne bliver ved siden af kroppen.", ["Ingen fart fra ryggen", "Bløde knæ", "Sænk på to sekunder"], "Lav øvelsen siddende.", "Brug en anelse mere vægt eller langsommere tempo."),
    ]
}
...
def build_strength_program(profile: dict[str, Any], week: int) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    ids = [
        ...
        "seated-band-row" if starter or back else "standing-band-row",
        "wall-plank" if starter or back else "knee-plank",
        "chair-march" if starter or knees else "supported-step-up",
        "glute-bridge",
        "supported-calf-raise" if starter else "calf-raise",
        "seated-shoulder-press" if starter or back else "standing-shoulder-press",
    ]
    if week >= 5:
        ids.append("seated-biceps-curl" if starter else "standing-biceps-curl")
